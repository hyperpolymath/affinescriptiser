...
use crate::abi::{AffinityKind, AffineResource, Violation, ViolationType};
...
pub fn generate_affine_module(
    ...
    // Module header.
    writeln!(source, "// AffineScript module generated by affinescriptiser").unwrap();
    writeln!(
        source,
        "// SPDX-License-Identifier: PMPL-1.0-or-later"
    )
...
mod tests {
    ...
    fn test_double_free_detection() {
        ...
        assert!(module.violations[0].violation.to_string().contains("DOUBLE-FREE"));
    }
    ...
    fn test_affine_resource_no_leak_violation() {
        ...
        let module = generate_affine_module("test", &resources, &sites);
        assert!(module.violations.is_empty(), "Affine resources should not report leaks");
    }
}
