...
Replace all {{PLACEHOLDER}} values with your information:
  affinescriptiser     - Your project name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/affinescriptiser/security/advisories/new)
...
- This repository (`hyperpolymath/affinescriptiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/affinescriptiser/security/advisories)
...
When using affinescriptiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/affinescriptiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/affinescriptiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/affinescriptiser/discussions) |
...
*Thank you for helping keep affinescriptiser and its users safe.* 🛡️
