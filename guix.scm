...
;;
;; Guix package definition for What Is Affinescriptiser?
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace What Is Affinescriptiser? and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/What Is Affinescriptiser?")
